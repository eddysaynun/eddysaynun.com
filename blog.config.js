...
const BLOG = {
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '55fdb4fe4d6d4250a7c7ff142fac4754',
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS || '爆竹声好大，应是开枪的好时机',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Edward Chen',
  BIO: process.env.NEXT_PUBLIC_BIO || 'New bird🕊️', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://eddysaynun.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL:
    process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'edward4run@outlook.com',
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/5600542277', // 微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/Jaffa4Cakee', // twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/jaffacakee',
  ...
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/7857109', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || '', // Youtube主页

  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.notion.so', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项

  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon_transparent.PNG', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  FONT_STYLE:
    process.env.NEXT_PUBLIC_FONT_STYLE || 'Times New Roman font-light',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Edward Chen’s Blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
